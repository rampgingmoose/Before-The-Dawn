...
namespace ST
{
    public class CharacterFXManager : MonoBehaviour
    {
        ...
        public Transform buildUpTransform; //location of build up particle effects
        public bool isPoisoned;
        public float poisonBuildUp = 0; //The buildup before you get poisoned over time that poisons the player after reaching 100
        ...
        public float poisonTimer = 2; //Amount of Time between each poison tick
