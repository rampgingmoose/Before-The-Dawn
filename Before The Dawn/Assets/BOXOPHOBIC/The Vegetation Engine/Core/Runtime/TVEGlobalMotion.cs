...
namespace TheVegetationEngine
{
    ...
    public class TVEGlobalMotion : StyledMonoBehaviour
    {
        ...
        void SetGlobalShaderProperties()
        {
            ...
            // X Minimum Bending Motion // Y Minimum Second Motion // Z Minimum Flutter Motion // W Wind Noise Dumpening
            Shader.SetGlobalVector("TVE_MotionTweaks", new Vector4(0.2f, 0.4f, 0.6f, 0.2f));
