		...
		Pass
		{
           ...
           #pragma instancing_options procedural:SetupNatureRenderer
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 VertexPosition3588_g54677 = v.vertex.xyz;
				float3 appendResult60_g55684 = (float3(v.texcoord.z , 0.0 , v.texcoord.w));
				half3 Mesh_PivotsData2831_g54677 = ( appendResult60_g55684 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g54677 = Mesh_PivotsData2831_g54677;
				float3 temp_output_2283_0_g54677 = ( VertexPosition3588_g54677 - Mesh_PivotsOS2291_g54677 );
				half3 VertexPos40_g55654 = temp_output_2283_0_g54677;
				...
				float Bounds_Height374_g54677 = _MaxBoundsInfo.y;
				half WorldData19_g55685 = ( Bounds_Height374_g54677 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g55685 = WorldData19_g55685;
				#else
				float staticSwitch14_g55685 = ObjectData20_g55685;
				#endif
				float Motion_Max_Bending1133_g54677 = staticSwitch14_g55685;
				...
				float3 vertexToFrag4224_g54677 = temp_output_114_0_g55633;
				half3 ObjectData20_g55680 = vertexToFrag4224_g54677;
				float3 vertexToFrag3890_g54677 = ase_worldPos;
				half3 WorldData19_g55680 = vertexToFrag3890_g54677;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g55680 = WorldData19_g55680;
				#else
				float3 staticSwitch14_g55680 = ObjectData20_g55680;
				#endif
				float3 ObjectPosition4223_g54677 = staticSwitch14_g55680;
				float3 Position83_g55689 = ObjectPosition4223_g54677;
				...
				half4 Global_Motion_Params3909_g54677 = lerpResult87_g55689;
				float4 break322_g55695 = Global_Motion_Params3909_g54677;
				half Wind_Power369_g55695 = break322_g55695.z;
				float lerpResult376_g55695 = lerp( TVE_MotionTweaks.x , 1.0 , Wind_Power369_g55695);
				half Wind_Power_103106_g54677 = lerpResult376_g55695;
				float2 panner73_g55630 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4223_g54677).xz * TVE_NoiseParams.z ));
				...
				half Wind_Power2223_g54677 = Wind_Power369_g55695;
				float temp_output_167_0_g55630 = Wind_Power2223_g54677;
				...
				half Global_NoiseTex_R34_g54677 = break174_g55630.r;
				...
				half2 Wind_DirectionOS39_g54677 = (temp_output_339_0_g55695).xz;
				half Input_Speed62_g55653 = _MotionSpeed_10;
				float mulTime373_g55653 = _TimeParameters.x * Input_Speed62_g55653;
				float3 break111_g55678 = ObjectPosition4223_g54677;
				...
				#endif
				half Motion_Variation3073_g54677 = staticSwitch14_g55679;
				half Motion_Variation284_g55653 = ( _MotionVariation_10 * Motion_Variation3073_g54677 );
				...
				half Wind_Squash4479_g54677 = TVE_MotionTweaks.w;
				half Input_WindSquash419_g55653 = Wind_Squash4479_g54677;
				half Input_WindPower327_g55653 = Wind_Power_103106_g54677;
				...
				half Mesh_Motion_1082_g54677 = v.ase_texcoord3.x;
				half2 Motion_10_Bending2258_g54677 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g54677 ) * Wind_Power_103106_g54677 * Global_NoiseTex_R34_g54677 * Wind_DirectionOS39_g54677 * lerpResult321_g55653 * Mesh_Motion_1082_g54677 );
				half Interaction_Amplitude4137_g54677 = _InteractionAmplitude;
				float3 Position83_g55652 = ObjectPosition4223_g54677;
				...
				half4 Global_React_Params4173_g54677 = lerpResult87_g55652;
				float4 break322_g55631 = Global_React_Params4173_g54677;
				half Interaction_Mask66_g54677 = break322_g55631.z;
				...
				half2 Interaction_DirectionOS4158_g54677 = (temp_output_339_0_g55631).xz;
				float lerpResult4494_g54677 = lerp( 1.0 , Mesh_Motion_1082_g54677 , _InteractionMaskValue);
				half2 Motion_10_Interaction53_g54677 = ( Interaction_Amplitude4137_g54677 * Motion_Max_Bending1133_g54677 * Interaction_Mask66_g54677 * Interaction_Mask66_g54677 * Interaction_DirectionOS4158_g54677 * lerpResult4494_g54677 );
				float2 lerpResult109_g54677 = lerp( Motion_10_Bending2258_g54677 , Motion_10_Interaction53_g54677 , ( Interaction_Mask66_g54677 * saturate( Interaction_Amplitude4137_g54677 ) ));
				float2 break143_g54677 = lerpResult109_g54677;
				half Motion_10_ZAxis190_g54677 = break143_g54677.y;
				half Angle44_g55654 = Motion_10_ZAxis190_g54677;
				...
				half Motion_10_XAxis216_g54677 = break143_g54677.x;
				half Angle44_g55663 = -Motion_10_XAxis216_g54677;
				...
				float Motion_Variation330_g55683 = ( _MotionVariation_32 * Motion_Variation3073_g54677 );
				float Bounds_Radius121_g54677 = _MaxBoundsInfo.x;
				half Input_Amplitude58_g55683 = ( _MotionAmplitude_32 * Bounds_Radius121_g54677 * 0.1 );
				...
				half Mesh_Motion_30144_g54677 = v.ase_texcoord3.z;
				float lerpResult378_g55695 = lerp( TVE_MotionTweaks.z , 1.0 , Wind_Power369_g55695);
				half Wind_Power_303115_g54677 = lerpResult378_g55695;
				float temp_output_7_0_g55672 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g54677 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g55672 ) / ( TVE_MotionFadeStart - temp_output_7_0_g55672 ) ) );
				half Motion_Selective4260_g54677 = 1.0;
				half3 Motion_30_Details263_g54677 = ( temp_output_299_0_g55683 * ( Global_NoiseTex_R34_g54677 * Mesh_Motion_30144_g54677 * Wind_Power_303115_g54677 * Wind_FadeOut4005_g54677 * Motion_Selective4260_g54677 ) );
				float3 Vertex_Motion_Object833_g54677 = ( ( VertexPosRotationAxis50_g55663 + ( VertexPosOtherAxis82_g55663 * cos( Angle44_g55663 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g55663 ) * sin( Angle44_g55663 ) ) ) + Motion_30_Details263_g54677 );
				float3 temp_output_3474_0_g54677 = ( VertexPosition3588_g54677 - Mesh_PivotsOS2291_g54677 );
				float3 appendResult2043_g54677 = (float3(Motion_10_XAxis216_g54677 , 0.0 , Motion_10_ZAxis190_g54677));
				float3 Vertex_Motion_World1118_g54677 = ( ( temp_output_3474_0_g54677 + appendResult2043_g54677 ) + Motion_30_Details263_g54677 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g54677 = Vertex_Motion_World1118_g54677;
				#else
				float3 staticSwitch3312_g54677 = ( Vertex_Motion_Object833_g54677 + ( 0.0 * _VertexDataMode ) );
				#endif
				half Global_Vertex_Size174_g54677 = break322_g55631.w;
				float lerpResult346_g54677 = lerp( 1.0 , Global_Vertex_Size174_g54677 , _GlobalSize);
				float3 appendResult3480_g54677 = (float3(lerpResult346_g54677 , lerpResult346_g54677 , lerpResult346_g54677));
				half3 ObjectData20_g55694 = appendResult3480_g54677;
				...
				#endif
				half3 Vertex_Size1741_g54677 = staticSwitch14_g55694;
				half3 _Vector5 = half3(1,1,1);
				float temp_output_7_0_g55690 = _SizeFadeEndValue;
				float temp_output_335_0_g54677 = saturate( ( ( ( distance( _WorldSpaceCameraPos , ObjectPosition4223_g54677 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g55690 ) / ( _SizeFadeStartValue - temp_output_7_0_g55690 ) ) );
				float3 appendResult3482_g54677 = (float3(temp_output_335_0_g54677 , temp_output_335_0_g54677 , temp_output_335_0_g54677));
				float3 lerpResult3556_g54677 = lerp( _Vector5 , appendResult3482_g54677 , _SizeFadeMode);
				half3 ObjectData20_g55697 = lerpResult3556_g54677;
				...
				#endif
				float3 Vertex_SizeFade1740_g54677 = staticSwitch14_g55697;
				float3 normalizeResult2696_g54677 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 break2709_g54677 = cross( normalizeResult2696_g54677 , half3(0,1,0) );
				float3 appendResult2710_g54677 = (float3(-break2709_g54677.z , 0.0 , break2709_g54677.x));
				float3 appendResult2667_g54677 = (float3(v.ase_color.r , 0.5 , v.ase_color.r));
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult2169_g54677 = normalize( ase_worldViewDir );
				float3 ViewDir_Normalized3963_g54677 = normalizeResult2169_g54677;
				float dotResult2212_g54677 = dot( ViewDir_Normalized3963_g54677 , float3(0,1,0) );
				half Mask_HView2656_g54677 = dotResult2212_g54677;
				float saferPower2652_g54677 = max( Mask_HView2656_g54677 , 0.0001 );
				half3 Grass_Coverage2661_g54677 = ( ( ( mul( GetWorldToObjectMatrix(), float4( appendResult2710_g54677 , 0.0 ) ).xyz * _PerspectivePushValue ) + ( (appendResult2667_g54677*2.0 + -1.0) * _PerspectiveNoiseValue ) ) * v.ase_color.a * pow( saferPower2652_g54677 , _PerspectiveAngleValue ) );
				float3 Final_VertexPosition890_g54677 = ( ( staticSwitch3312_g54677 * Vertex_Size1741_g54677 * Vertex_SizeFade1740_g54677 ) + Mesh_PivotsOS2291_g54677 + Grass_Coverage2661_g54677 );
				
				float temp_output_7_0_g55657 = _GradientMinValue;
				float4 lerpResult2779_g54677 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( v.ase_color.a - temp_output_7_0_g55657 ) / ( _GradientMaxValue - temp_output_7_0_g55657 ) ) ));
				half3 Gradient_Tint2784_g54677 = (lerpResult2779_g54677).rgb;
				float3 vertexToFrag11_g55640 = Gradient_Tint2784_g54677;
				o.ase_texcoord7.xyz = vertexToFrag11_g55640;
				float3 temp_cast_15 = (_NoiseScaleValue).xxx;
				float3 WorldPosition3905_g54677 = vertexToFrag3890_g54677;
				float temp_output_7_0_g55666 = _NoiseMinValue;
				half Noise_Mask3162_g54677 = saturate( ( ( SAMPLE_TEXTURE3D_LOD( TVE_WorldTex3D, samplerTVE_WorldTex3D, ( temp_cast_15 * WorldPosition3905_g54677 * 0.1 ), 0.0 ).r - temp_output_7_0_g55666 ) / ( _NoiseMaxValue - temp_output_7_0_g55666 ) ) );
				float4 lerpResult2800_g54677 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask3162_g54677);
				half3 Noise_Tint2802_g54677 = (lerpResult2800_g54677).rgb;
				float3 vertexToFrag11_g55642 = Noise_Tint2802_g54677;
				o.ase_texcoord8.xyz = vertexToFrag11_g55642;
				float lerpResult169_g55630 = lerp( 4.0 , 2.0 , temp_output_167_0_g55630);
				half Global_NoiseTex_H2869_g54677 = pow( abs( tex2DNode75_g55630.a ) , lerpResult169_g55630 );
				half3 Highlight_Tint3231_g54677 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g54677 * Wind_Power_103106_g54677 * Wind_FadeOut4005_g54677 * v.ase_color.a ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g55673 = Highlight_Tint3231_g54677;
				...
				float3 Position58_g55622 = WorldPosition3905_g54677;
				...
				half Global_ColorsTex_A1701_g54677 = (lerpResult88_g55622).a;
				float vertexToFrag11_g55644 = Global_ColorsTex_A1701_g54677;
				o.ase_texcoord7.w = vertexToFrag11_g55644;
				o.ase_texcoord11.xyz = vertexToFrag3890_g54677;
				float3 temp_cast_18 = (1.0).xxx;
				float Mesh_Occlusion318_g54677 = v.ase_color.g;
				float temp_output_7_0_g55681 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g54677 = lerp( (_VertexOcclusionColor).rgb , temp_cast_18 , saturate( ( ( Mesh_Occlusion318_g54677 - temp_output_7_0_g55681 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g55681 ) ) ));
				float3 vertexToFrag11_g55637 = lerpResult2945_g54677;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g54677;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				half2 Main_UVs15_g54677 = vertexToFrag11_g55638;
				float4 tex2DNode29_g54677 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g54677 );
				float3 temp_output_51_0_g54677 = ( (_MainColor).rgb * (tex2DNode29_g54677).rgb );
				half3 Main_Albedo99_g54677 = temp_output_51_0_g54677;
				half3 Blend_Albedo265_g54677 = Main_Albedo99_g54677;
				half3 Blend_AlbedoTinted2808_g54677 = ( vertexToFrag11_g55640 * vertexToFrag11_g55642 * vertexToFrag11_g55673 * Blend_Albedo265_g54677 );
				float dotResult3616_g54677 = dot( Blend_AlbedoTinted2808_g54677 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g54677).xxx;
				float vertexToFrag11_g55644 = IN.ase_texcoord7.w;
				half Global_Colors_Influence3668_g54677 = vertexToFrag11_g55644;
				float3 lerpResult3618_g54677 = lerp( Blend_AlbedoTinted2808_g54677 , temp_cast_0 , Global_Colors_Influence3668_g54677);
				float3 vertexToFrag3890_g54677 = IN.ase_texcoord11.xyz;
				float3 WorldPosition3905_g54677 = vertexToFrag3890_g54677;
				float3 Position58_g55622 = WorldPosition3905_g54677;
				float temp_output_82_0_g55622 = _LayerColorsValue;
				...
				half3 Global_ColorsTex_RGB1700_g54677 = (lerpResult88_g55622).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g55676 = 2.0;
				#else
				float staticSwitch1_g55676 = 4.594794;
				#endif
				half3 Global_Colors1954_g54677 = ( Global_ColorsTex_RGB1700_g54677 * staticSwitch1_g55676 );
				float lerpResult3870_g54677 = lerp( 1.0 , IN.ase_color.r , _ColorsVariationValue);
				half Global_Colors_Value3650_g54677 = ( _GlobalColors * lerpResult3870_g54677 );
				float temp_output_7_0_g55677 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g54677 = saturate( ( ( ( 1.0 - IN.ase_color.a ) - temp_output_7_0_g55677 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g55677 ) ) );
				float3 lerpResult3628_g54677 = lerp( Blend_AlbedoTinted2808_g54677 , ( lerpResult3618_g54677 * Global_Colors1954_g54677 ) , ( Global_Colors_Value3650_g54677 * Global_Colors_Mask3692_g54677 ));
				half3 Blend_AlbedoColored863_g54677 = lerpResult3628_g54677;
				float3 temp_output_799_0_g54677 = (_SubsurfaceColor).rgb;
				float dotResult3930_g54677 = dot( temp_output_799_0_g54677 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g54677).xxx;
				float3 lerpResult3932_g54677 = lerp( temp_output_799_0_g54677 , temp_cast_3 , Global_Colors_Influence3668_g54677);
				float3 lerpResult3942_g54677 = lerp( temp_output_799_0_g54677 , ( lerpResult3932_g54677 * Global_Colors1954_g54677 ) , ( Global_Colors_Value3650_g54677 * Global_Colors_Mask3692_g54677 ));
				half3 Subsurface_Color1722_g54677 = lerpResult3942_g54677;
				half MainLight_Subsurface4041_g54677 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g54677 = ( _SubsurfaceValue * MainLight_Subsurface4041_g54677 );
				float temp_output_7_0_g55662 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g54677 = saturate( ( ( IN.ase_color.a - temp_output_7_0_g55662 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g55662 ) ) );
				half3 Subsurface_Transmission884_g54677 = ( Subsurface_Color1722_g54677 * Subsurface_Intensity1752_g54677 * Subsurface_Mask1557_g54677 );
				half3 MainLight_Direction3926_g54677 = TVE_MainLightDirection;
				float3 normalizeResult2169_g54677 = normalize( WorldViewDirection );
				float3 ViewDir_Normalized3963_g54677 = normalizeResult2169_g54677;
				float dotResult785_g54677 = dot( -MainLight_Direction3926_g54677 , ViewDir_Normalized3963_g54677 );
				float saferPower1624_g54677 = max( (dotResult785_g54677*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g54677 = 0.0;
				#else
				float staticSwitch1602_g54677 = ( pow( saferPower1624_g54677 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g54677 = staticSwitch1602_g54677;
				half3 Subsurface_Scattering1693_g54677 = ( Subsurface_Transmission884_g54677 * Blend_AlbedoColored863_g54677 * Mask_Subsurface_View782_g54677 );
				half3 Blend_AlbedoAndSubsurface149_g54677 = ( Blend_AlbedoColored863_g54677 + Subsurface_Scattering1693_g54677 );
				half3 Global_OverlayColor1758_g54677 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g54677 = tex2DNode29_g54677.g;
				float3 Position82_g55688 = WorldPosition3905_g54677;
				...
				half Global_Extras_Overlay156_g54677 = break89_g55688.b;
				float temp_output_1025_0_g54677 = ( _GlobalOverlay * Global_Extras_Overlay156_g54677 );
				float lerpResult1065_g54677 = lerp( 1.0 , IN.ase_color.r , _OverlayVariationValue);
				half Overlay_Commons1365_g54677 = ( temp_output_1025_0_g54677 * lerpResult1065_g54677 );
				float temp_output_7_0_g55646 = _OverlayMaskMinValue;
				half Overlay_Mask269_g54677 = saturate( ( ( ( ( ( IN.ase_color.a * 0.5 ) + Main_AlbedoTex_G3526_g54677 ) * Overlay_Commons1365_g54677 ) - temp_output_7_0_g55646 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g55646 ) ) );
				float3 lerpResult336_g54677 = lerp( Blend_AlbedoAndSubsurface149_g54677 , Global_OverlayColor1758_g54677 , Overlay_Mask269_g54677);
				half3 Final_Albedo359_g54677 = lerpResult336_g54677;
				float3 vertexToFrag11_g55637 = IN.ase_texcoord12.xyz;
				float3 Vertex_Occlusion648_g54677 = saturate( vertexToFrag11_g55637 );
				
				float3 unpack4112_g54677 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g54677 ), _MainNormalValue );
				unpack4112_g54677.z = lerp( 1, unpack4112_g54677.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g54677 = unpack4112_g54677;
				float3 temp_output_13_0_g55674 = Main_Normal137_g54677;
				float3 switchResult12_g55674 = (((ase_vface>0)?(temp_output_13_0_g55674):(( temp_output_13_0_g55674 * _render_normals_options ))));
				half3 Blend_Normal312_g54677 = switchResult12_g55674;
				half3 Final_Normal366_g54677 = Blend_Normal312_g54677;
				
				float4 temp_output_4214_0_g54677 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g55682 = IN.ase_texcoord10.zw;
				half2 Emissive_UVs2468_g54677 = vertexToFrag11_g55682;
				half Global_Extras_Emissive4203_g54677 = break89_g55688.r;
				float lerpResult4206_g54677 = lerp( 1.0 , Global_Extras_Emissive4203_g54677 , _GlobalEmissive);
				half3 Final_Emissive2476_g54677 = ( (( temp_output_4214_0_g54677 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g54677 ) )).rgb * lerpResult4206_g54677 );
				
				float3 temp_cast_7 = (( 0.04 * _RenderSpecular )).xxx;
				
				float4 tex2DNode35_g54677 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g54677 );
				half Main_Smoothness227_g54677 = ( tex2DNode35_g54677.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g54677 = Main_Smoothness227_g54677;
				half Global_OverlaySmoothness311_g54677 = TVE_OverlaySmoothness;
				float lerpResult343_g54677 = lerp( Blend_Smoothness314_g54677 , Global_OverlaySmoothness311_g54677 , Overlay_Mask269_g54677);
				half Final_Smoothness371_g54677 = lerpResult343_g54677;
				half Global_Extras_Wetness305_g54677 = break89_g55688.g;
				float lerpResult3673_g54677 = lerp( 0.0 , Global_Extras_Wetness305_g54677 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g54677 = saturate( ( Final_Smoothness371_g54677 + lerpResult3673_g54677 ) );
				
				float lerpResult240_g54677 = lerp( 1.0 , tex2DNode35_g54677.g , _MainOcclusionValue);
				half Main_Occlusion247_g54677 = lerpResult240_g54677;
				half Blend_Occlusion323_g54677 = Main_Occlusion247_g54677;
				
				float localCustomAlphaClip3735_g54677 = ( 0.0 );
				half Final_AlphaFade3727_g54677 = 1.0;
				float Main_Alpha316_g54677 = ( _MainColor.a * tex2DNode29_g54677.a );
				float Mesh_Variation16_g54677 = IN.ase_color.r;
				float lerpResult4033_g54677 = lerp( 0.9 , (Mesh_Variation16_g54677*0.5 + 0.5) , _AlphaVariationValue);
				half Global_Extras_Alpha1033_g54677 = break89_g55688.a;
				float temp_output_4022_0_g54677 = ( lerpResult4033_g54677 - ( 1.0 - Global_Extras_Alpha1033_g54677 ) );
				half AlphaTreshold2132_g54677 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch4017_g54677 = ( temp_output_4022_0_g54677 + AlphaTreshold2132_g54677 );
				#else
				float staticSwitch4017_g54677 = temp_output_4022_0_g54677;
				#endif
				float lerpResult4011_g54677 = lerp( 1.0 , staticSwitch4017_g54677 , _GlobalAlpha);
				half Global_Alpha315_g54677 = saturate( lerpResult4011_g54677 );
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g54677 = ( ( Main_Alpha316_g54677 * Global_Alpha315_g54677 ) - ( AlphaTreshold2132_g54677 - 0.5 ) );
				#else
				float staticSwitch3792_g54677 = ( Main_Alpha316_g54677 * Global_Alpha315_g54677 );
				#endif
				half Final_Alpha3754_g54677 = staticSwitch3792_g54677;
				float temp_output_661_0_g54677 = ( Final_AlphaFade3727_g54677 * Final_Alpha3754_g54677 );
				float Alpha3735_g54677 = temp_output_661_0_g54677;
				float Treshold3735_g54677 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g54677 - Treshold3735_g54677);
				#endif
				}
				half Final_Clip914_g54677 = saturate( Alpha3735_g54677 );
				
				float3 Albedo = ( Final_Albedo359_g54677 * Vertex_Occlusion648_g54677 );
				float3 Normal = Final_Normal366_g54677;
				float3 Emission = Final_Emissive2476_g54677;
				float3 Specular = temp_cast_7;
				float Metallic = 0;
				float Smoothness = Final_SmoothnessAndWetness4130_g54677;
				float Occlusion = Blend_Occlusion323_g54677;
				float Alpha = Final_Clip914_g54677;
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
				float3 BakedGI = 0;
				float3 RefractionColor = 1;
				float RefractionIndex = 1;
				float3 Transmission = Subsurface_Transmission884_g54677;
		...
		Pass
		{
           ...
           #pragma instancing_options procedural:SetupNatureRenderer
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				o.ase_texcoord3.xyz = vertexToFrag3890_g54677;
						 ...
						 ) : SV_TARGET
			{
				...
				float Mesh_Variation16_g54677 = IN.ase_color.r;
				float lerpResult4033_g54677 = lerp( 0.9 , (Mesh_Variation16_g54677*0.5 + 0.5) , _AlphaVariationValue);
				float3 vertexToFrag3890_g54677 = IN.ase_texcoord3.xyz;
				float3 WorldPosition3905_g54677 = vertexToFrag3890_g54677;
				float3 Position82_g55688 = WorldPosition3905_g54677;
				float temp_output_84_0_g55688 = _LayerExtrasValue;
				float4 lerpResult88_g55688 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g55688).xz ) ),temp_output_84_0_g55688 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g55688]);
		...
		Pass
		{
           ...
           #pragma instancing_options procedural:SetupNatureRenderer
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord6.xyz = vertexToFrag3890_g54677;
				float3 temp_cast_18 = (1.0).xxx;
				float Mesh_Occlusion318_g54677 = v.ase_color.g;
				float temp_output_7_0_g55681 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g54677 = lerp( (_VertexOcclusionColor).rgb , temp_cast_18 , saturate( ( ( Mesh_Occlusion318_g54677 - temp_output_7_0_g55681 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g55681 ) ) ));
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half Global_Colors_Influence3668_g54677 = vertexToFrag11_g55644;
				float3 lerpResult3618_g54677 = lerp( Blend_AlbedoTinted2808_g54677 , temp_cast_0 , Global_Colors_Influence3668_g54677);
				float3 vertexToFrag3890_g54677 = IN.ase_texcoord6.xyz;
				float3 WorldPosition3905_g54677 = vertexToFrag3890_g54677;
				float3 Position58_g55622 = WorldPosition3905_g54677;
				float temp_output_82_0_g55622 = _LayerColorsValue;
				float4 lerpResult88_g55622 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g55622).xz ) ),temp_output_82_0_g55622 ) , TVE_ColorsUsage[(int)temp_output_82_0_g55622]);
...
Node;AmplifyShaderEditor.FunctionNode;1042;-1536,-896;Inherit;False;Compile Core;-1;;55701;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1040;-1920,384;Inherit;False;Define FEATURES UNIVERSAL;-1;;55699;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;713;-2176,384;Inherit;False;Define SHADER GRASS;-1;;55698;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1041;-1344,-896;Inherit;False;Compile All Shaders;-1;;55700;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=97CB854DB340B968B58AA45ACA0EE3701CCE5DF6
