		...
		Pass
		{
           ...
           #pragma instancing_options procedural:SetupNatureRenderer
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord7.xy = vertexToFrag11_g55666;
				float2 lerpResult1545_g55655 = lerp( v.texcoord.xy , v.texcoord1.xyzw.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g55655 = lerpResult1545_g55655;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float2 staticSwitch3466_g55655 = (ase_worldPos).xz;
				#else
				float2 staticSwitch3466_g55655 = lerpResult1545_g55655;
				#endif
				float2 vertexToFrag11_g55678 = ( ( staticSwitch3466_g55655 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord7.zw = vertexToFrag11_g55678;
				half Mesh_DetailMask90_g55655 = v.ase_color.b;
				float vertexToFrag11_g55711 = ( ( Mesh_DetailMask90_g55655 - 0.5 ) + _DetailMeshValue );
				o.ase_texcoord8.x = vertexToFrag11_g55711;
				float3 vertexToFrag3890_g55655 = ase_worldPos;
				o.ase_texcoord8.yzw = vertexToFrag3890_g55655;
				
				float2 vertexToFrag11_g55707 = ( ( v.texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				o.ase_texcoord9.xy = vertexToFrag11_g55707;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 vertexToFrag11_g55666 = IN.ase_texcoord7.xy;
				...
				float2 vertexToFrag11_g55678 = IN.ase_texcoord7.zw;
				half2 Second_UVs17_g55655 = vertexToFrag11_g55678;
				half3 Second_Albedo153_g55655 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g55655 ) )).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g55668 = 2.0;
				#else
				float staticSwitch1_g55668 = 4.594794;
				#endif
				float vertexToFrag11_g55711 = IN.ase_texcoord8.x;
				float temp_output_3919_0_g55655 = vertexToFrag11_g55711;
				...
				float lerpResult1537_g55655 = lerp( Main_Normal_WS4101_g55655.y , -Main_Normal_WS4101_g55655.y , _DetailProjectionMode);
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float staticSwitch3467_g55655 = temp_output_3919_0_g55655;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float staticSwitch3467_g55655 = ( ( lerpResult1537_g55655 * 0.5 ) + _DetailMeshValue );
				#else
				float staticSwitch3467_g55655 = temp_output_3919_0_g55655;
				#endif
				half Blend_Source1540_g55655 = staticSwitch3467_g55655;
				...
				float4 tex2DNode33_g55655 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_SecondMaskTex, Second_UVs17_g55655 );
				...
				float temp_output_7_0_g55670 = _DetailBlendMinValue;
				half Mask_Detail147_g55655 = saturate( ( ( saturate( ( Blend_Source1540_g55655 + ( Blend_Source1540_g55655 * lerpResult4058_g55655 ) ) ) - temp_output_7_0_g55670 ) / ( _DetailBlendMaxValue - temp_output_7_0_g55670 ) ) );
				float3 lerpResult235_g55655 = lerp( Main_Albedo99_g55655 , ( Main_Albedo99_g55655 * Second_Albedo153_g55655 * staticSwitch1_g55668 ) , Mask_Detail147_g55655);
				float3 lerpResult208_g55655 = lerp( Main_Albedo99_g55655 , Second_Albedo153_g55655 , Mask_Detail147_g55655);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g55655 = lerpResult235_g55655;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g55655 = lerpResult208_g55655;
				#else
				float3 staticSwitch4062_g55655 = lerpResult235_g55655;
				#endif
				...
				float3 staticSwitch255_g55655 = staticSwitch4062_g55655;
				#else
				float3 staticSwitch255_g55655 = Main_Albedo99_g55655;
				#endif
				half3 Blend_Albedo265_g55655 = staticSwitch255_g55655;
				half3 Blend_AlbedoTinted2808_g55655 = ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) * Blend_Albedo265_g55655 );
				...
				half Second_AlbedoTex_G3581_g55655 = (SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g55655 )).g;
				...
				float staticSwitch3574_g55655 = Main_AlbedoTex_G3526_g55655;
				#endif
				float3 vertexToFrag3890_g55655 = IN.ase_texcoord8.yzw;
				...
				half Overlay_Commons1365_g55655 = temp_output_1025_0_g55655;
				float temp_output_7_0_g55673 = _OverlayMaskMinValue;
				half Overlay_Mask269_g55655 = saturate( ( ( ( ( ( lerpResult3567_g55655 * 0.5 ) + staticSwitch3574_g55655 ) * Overlay_Commons1365_g55655 ) - temp_output_7_0_g55673 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g55673 ) ) );
				...
				float3 unpack4114_g55655 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_SecondMaskTex, Second_UVs17_g55655 ), _SecondNormalValue );
				...
				float3 lerpResult230_g55655 = lerp( float3( 0,0,1 ) , Second_Normal179_g55655 , Mask_Detail147_g55655);
				...
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g55655 = BlendNormal( Main_Normal137_g55655 , lerpResult230_g55655 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g55655 = lerpResult3376_g55655;
				#else
				float3 staticSwitch4063_g55655 = BlendNormal( Main_Normal137_g55655 , lerpResult230_g55655 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g55655 = staticSwitch4063_g55655;
				#else
				float3 staticSwitch267_g55655 = Main_Normal137_g55655;
				#endif
				float3 temp_output_13_0_g55699 = staticSwitch267_g55655;
				...
				float2 vertexToFrag11_g55707 = IN.ase_texcoord9.xy;
				...
				half Main_Metallic237_g55655 = ( tex2DNode35_g55655.r * _MainMetallicValue );
				half Second_Metallic226_g55655 = ( tex2DNode33_g55655.r * _SecondMetallicValue );
				float lerpResult278_g55655 = lerp( Main_Metallic237_g55655 , Second_Metallic226_g55655 , Mask_Detail147_g55655);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4064_g55655 = Main_Metallic237_g55655;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4064_g55655 = lerpResult278_g55655;
				#else
				float staticSwitch4064_g55655 = Main_Metallic237_g55655;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch299_g55655 = Main_Metallic237_g55655;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch299_g55655 = staticSwitch4064_g55655;
				#else
				float staticSwitch299_g55655 = Main_Metallic237_g55655;
				#endif
				half Blend_Metallic306_g55655 = staticSwitch299_g55655;
				float lerpResult342_g55655 = lerp( Blend_Metallic306_g55655 , 0.0 , Overlay_Mask269_g55655);
				half Final_Metallic367_g55655 = lerpResult342_g55655;
				...
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g55655 = Main_Smoothness227_g55655;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g55655 = lerpResult266_g55655;
				#else
				float staticSwitch4065_g55655 = Main_Smoothness227_g55655;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g55655 = staticSwitch4065_g55655;
				#else
				float staticSwitch297_g55655 = Main_Smoothness227_g55655;
				#endif
				...
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g55655 = Main_Occlusion247_g55655;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g55655 = lerpResult294_g55655;
				#else
				float staticSwitch4066_g55655 = Main_Occlusion247_g55655;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g55655 = staticSwitch4066_g55655;
				#else
				float staticSwitch310_g55655 = Main_Occlusion247_g55655;
				#endif
				...
				float3 Specular = 0.5;
				float Metallic = Final_Metallic367_g55655;
		...
		Pass
		{
           ...
           #pragma instancing_options procedural:SetupNatureRenderer
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag11_g55666 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g55666;
				float2 lerpResult1545_g55655 = lerp( v.ase_texcoord.xy , v.texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g55655 = lerpResult1545_g55655;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				#endif
				float2 vertexToFrag11_g55678 = ( ( staticSwitch3466_g55655 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord2.zw = vertexToFrag11_g55678;
				half Mesh_DetailMask90_g55655 = v.ase_color.b;
				float vertexToFrag11_g55711 = ( ( Mesh_DetailMask90_g55655 - 0.5 ) + _DetailMeshValue );
				o.ase_texcoord3.x = vertexToFrag11_g55711;
				...
				o.ase_texcoord7.xy = vertexToFrag11_g55707;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_51_0_g55655 = ( (_MainColor).rgb * (tex2DNode29_g55655).rgb );
				half3 Main_Albedo99_g55655 = temp_output_51_0_g55655;
				float2 vertexToFrag11_g55678 = IN.ase_texcoord2.zw;
				half2 Second_UVs17_g55655 = vertexToFrag11_g55678;
				half3 Second_Albedo153_g55655 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g55655 ) )).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g55668 = 2.0;
				...
				float staticSwitch1_g55668 = 4.594794;
				#endif
				float vertexToFrag11_g55711 = IN.ase_texcoord3.x;
				float temp_output_3919_0_g55655 = vertexToFrag11_g55711;
				float3 unpack4112_g55655 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g55655 ), _MainNormalValue );
				unpack4112_g55655.z = lerp( 1, unpack4112_g55655.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g55655 = unpack4112_g55655;
				...
				float4 temp_output_4214_0_g55655 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g55707 = IN.ase_texcoord7.xy;
				half2 Emissive_UVs2468_g55655 = vertexToFrag11_g55707;
				half Global_Extras_Emissive4203_g55655 = break89_g55713.r;
				float lerpResult4206_g55655 = lerp( 1.0 , Global_Extras_Emissive4203_g55655 , _GlobalEmissive);
				half3 Final_Emissive2476_g55655 = ( (( temp_output_4214_0_g55655 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g55655 ) )).rgb * lerpResult4206_g55655 );
		...
		Pass
		{
           ...
           #pragma instancing_options procedural:SetupNatureRenderer
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag11_g55666 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g55666;
				float2 lerpResult1545_g55655 = lerp( v.ase_texcoord.xy , v.ase_texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g55655 = lerpResult1545_g55655;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2914.487;743.213;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;343;-2176,384;Inherit;False;Define SHADER OBJECT;-1;;55654;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;397;-1920,384;Inherit;False;Define FEATURES UNIVERSAL;-1;;55653;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;399;-1536,-896;Inherit;False;Compile Core;-1;;55652;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;398;-1344,-896;Inherit;False;Compile All Shaders;-1;;55651;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6C0DEDABB2FD35235C3CC9FC77344F4AA949D4D2
