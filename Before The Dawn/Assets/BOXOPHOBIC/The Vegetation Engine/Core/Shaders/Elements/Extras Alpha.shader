	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 temp_output_11_0_g18973 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				half4 tex2DNode17_g18973 = tex2D( _MainTex, temp_output_11_0_g18973 );
				half temp_output_7_0_g19359 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g19359).xxxx;
				half4 break469_g18973 = saturate( ( ( tex2DNode17_g18973 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
				...
				half2 temp_output_851_0_g18973 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
				...
				half temp_output_9_0_g19366 = lerpResult378_g18973;
				half sRGB8_g19366 = temp_output_9_0_g19366;
				half localGammaToLinearFloatFast8_g19366 = GammaToLinearFloatFast( sRGB8_g19366 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g19366 = temp_output_9_0_g19366;
				#else
				float staticSwitch1_g19366 = localGammaToLinearFloatFast8_g19366;
				#endif
				half Final_Alpha_A211_g18973 = staticSwitch1_g19366;
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1300.946;1881.14;1;True;False
Node;AmplifyShaderEditor.FunctionNode;111;-640,-1152;Inherit;False;Base Element;2;;18973;0e972c73cae2ee54ea51acc9738801d0;7,477,1,478,0,145,3,481,0,576,1,491,1,903,0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;106;-640,-1408;Inherit;False;Define ELEMENT EXTRAS;49;;19374;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C350199DF2374E41500B8B414D1C07D465466010