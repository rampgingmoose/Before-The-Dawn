	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 temp_output_11_0_g18997 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode17_g18997 = tex2D( _MainTex, temp_output_11_0_g18997 );
				float temp_output_7_0_g19359 = _MainTexMinValue;
				float4 temp_cast_0 = (temp_output_7_0_g19359).xxxx;
				float4 break469_g18997 = saturate( ( ( tex2DNode17_g18997 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
				...
				float2 temp_cast_1 = (temp_output_7_0_g19363).xx;
				float2 temp_output_851_0_g18997 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1525.264;1817.589;1;True;False
Node;AmplifyShaderEditor.FunctionNode;128;-768,-1025;Inherit;False;Base Element;4;;18997;0e972c73cae2ee54ea51acc9738801d0;7,477,2,478,0,145,1,481,4,576,1,491,1,903,0;0;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;129;-768,-1280;Inherit;False;Define ELEMENT REACT;0;;19374;9f8670cd8fdc98444822270656343d82;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=5841F019C7E0809EE76D9F3947886C780EDFFEAD