	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				// Speed of animation
				float fbspeed1 = _TimeParameters.x * (float)_AnimationSpeed;
				...
				// Flipbook UV
				half2 fbuv1 = texCoord3 * fbtiling1 + fboffset1;
				// *** END Flipbook UV Animation vars ***
				float4 tex2DNode2 = tex2D( _TextureSample0, fbuv1 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _ColorTint * tex2DNode2 ).rgb;
				float Alpha = ( pow( tex2DNode2.a , _AlphaMultiply ) * _Opacity );
...
/*ASEBEGIN
Version=18912
801;419;2305;1074;908.1506;354.5234;1;True;False
...
ASEEND*/
//CHKSM=F591A014B931AB70779C0A753738F3E5EA2FDB45