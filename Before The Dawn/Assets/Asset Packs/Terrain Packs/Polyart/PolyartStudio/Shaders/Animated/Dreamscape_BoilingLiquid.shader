...
Shader "Polyart/Animated/Boiling Liquid"
{
	Properties
	{
		...
		[ASEBegin]_BaseColor("Base Color", Color) = (0.08539513,0.9528302,0.1375322,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float3 appendResult10 = (float3((ase_worldPos).xz , ( (ase_worldPos).y + ( ( _TimeParameters.x ) * _BoilingSpeed ) )));
				...
				#endif
				float3 vertexValue = ( ( temp_output_20_0 * _HeightMultiply ) * v.ase_normal );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float3 appendResult10 = (float3((WorldPosition).xz , ( (WorldPosition).y + ( ( _TimeParameters.x ) * _BoilingSpeed ) )));
				float simplePerlin3D18 = snoise( appendResult10*8.0 );
				float simplePerlin3D1 = snoise( appendResult10*4.0 );
				float temp_output_20_0 = ( ( simplePerlin3D18 * _Noise ) + simplePerlin3D1 );
				...
				float Alpha = ( clampResult24 + ( 1.0 - _Transparency ) );
...
/*ASEBEGIN
Version=18912
510;1031;2305;1068;158.0326;246.4989;1;True;False
...
WireConnection;35;5;13;0
ASEEND*/
//CHKSM=48A6E07C83BC03E92979B728633F2732AACB6AE1