...
public static class Tooltips {
	...
	{"Gradient Color", "Sets the color of the gradient overlay part"},
        ...
        {"Enable", "Enables overriding of light direction. Use it when you want to re-align the shaded part for the current Mat only"},
        {"Pitch", "Moves the shaded part across world-space X coordinate"},
        {"Yaw", "Moves the shaded part across world-space Y coordinate"},
	{"Mode", "Use this menu to let the current Mat receive shadows. 'Multiply' parameter multiplies black shadow over existing colors of shading; 'Color' parameter applies freely colored shadow over existing colors of shading"},
